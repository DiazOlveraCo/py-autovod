...
class Processor:
        ...
        while not self.video_queue.empty():
            ...
            try:
                ...
                if streamer_config.getboolean("encoding","re_encode"): 
                    ...
                    if new_video_path:
                        logger.success(f"Video saved locally: {new_video_path}")
    ...
    def _process_single_file(self, video_path, streamer_name=None):
        ...
        try:
            ...
            if not os.getenv("OPEN_ROUTER_KEY"):
                ...
                logger.error("Please set it with: export OPEN_ROUTER_KEY='your_key_here'")
                return
    ...
    def _encode(self, video_path, streamer_config):
        try:
            ...
            # Check if re-encoding is enabled
            if streamer_config.getboolean("encoding", "re_encode", fallback=False):
                ...
                # If re-encoding is disabled, just copy the file
                logger.info(f"Re-encoding disabled.")
