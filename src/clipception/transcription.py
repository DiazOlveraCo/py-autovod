...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Process video with enhanced Whisper transcription')
    parser.add_argument('input_file', type=str, help='Path to the video file to process')
